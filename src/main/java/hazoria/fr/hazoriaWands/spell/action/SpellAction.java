...
import hazoria.fr.hazoriaWands.spell.action.impl.KnockbackAction;
import hazoria.fr.hazoriaWands.spell.action.impl.OpenDoorsAction;
...
public interface SpellAction {
    ...
    static SpellAction fromConfig(ConfigurationSection section) {
        ...
        return switch (cls.toLowerCase()) {
            ...
            case "knockback"   -> new KnockbackAction(section);
            case "opendoors"   -> new OpenDoorsAction(section);
